...
public class SingletonDemo {
    public static void main(String[] args) {
        ...
        System.out.println("=> HashCode khác nhau (tức là 2 object khác nhau) nếu xảy ra race condition.");

        System.out.println("\n(Để an toàn, reset instance về null nếu có thể, hoặc bỏ qua bước này trong code thực tế)");
